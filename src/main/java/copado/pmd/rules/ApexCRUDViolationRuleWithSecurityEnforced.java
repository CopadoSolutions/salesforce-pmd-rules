 ...
 *
 * @author sergey.gorbaty - ported from latest PMD updates
 *
 */
public class ApexCRUDViolationRuleWithSecurityEnforced extends AbstractApexRule {
    ...
    public ApexCRUDViolationRuleWithSecurityEnforced() {
